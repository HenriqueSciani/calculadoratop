...
public class operacao {
    ...
    public String soma(Calculadora objeto) {
        ...
        System.out.println("");
        String mensagemRetorno = "O RESULTADO DA SOMA FOI " + resultado;
    ...
    public String subtracao(Calculadora objeto) {
        ...
        double resultado = objeto.getValor1() - objeto.getValor2();
        System.out.println("");
        String mensagemRetorno = "O RESULTADO DA SUBRTRACAO FOI " + resultado;
        return mensagemRetorno;
    ...
    public String multiplicacao(Calculadora objeto) {
        ...
        double resultado = objeto.getValor1() * objeto.getValor2();
        System.out.println("");
        String mensagemRetorno = "O RESULTADO DA MULTIPLICACAO FOI " + resultado;
        return mensagemRetorno;
    ...
    public String divisao(Calculadora objeto) {
        ...
        double resultado = objeto.getValor1() / objeto.getValor2();
        System.out.println("");
        String mensagemRetorno = "O RESULTADO DA DIVISAO FOI " + resultado;
        return mensagemRetorno;
